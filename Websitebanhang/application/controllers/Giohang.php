...
class Giohang extends CI_Controller {
	...
	public function index(){
        $this->data['title']= 'NTQ Solution - Giỏ hàng của bạn';
    ...
    public function checkout(){
        if($this->session->userdata('session24hStore')){
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $this->data['title']= 'NTQ Solution - Đặt hàng';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->email->from('24hstore@gmail.com', 'NTQ Solution');
            $list = array('ngotrungphat@gmail.com');//Mặc định là email của admin
            $this->email->to($list);
            $this->email->subject('NTQ Solution');
            ...
            $this->data['title']= 'NTQ Solution - Thông tin đơn hàng';
