<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#8ac400">NTQ Solution</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2023 <a href="https://www.facebook.com/" style="color:red">Admin</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
