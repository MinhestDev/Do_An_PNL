...
<body>
	<div style="font-family:&quot;Arial&quot;,Helvetica Neue,Helvetica,sans-serif;line-height:18pt">
		<p>Xin chào <?php
					...
					?></p>
		<p>Cảm ơn Anh/chị đã đặt hàng tại <strong>NTQ Solution</strong>!</p>
		...
		&nbsp;
		<hr>
		<p style="text-align:right">Nếu Anh/chị có bất kỳ câu hỏi nào, xin liên hệ với chúng tôi tại <span style="color:#17a3dd"><a href="mailto:ntqsolution@gmail.com" target="_blank">ntqsolution@gmail.com</a></span></p>
		<p style="text-align:right"><i>Trân trọng,</i></p>
		<p style="text-align:right"><strong>Ban quản trị cửa hàng 24hStore</strong></p>
		<div class="yj6qo"></div>
		<div class="adL">
		</div>
	</div>
